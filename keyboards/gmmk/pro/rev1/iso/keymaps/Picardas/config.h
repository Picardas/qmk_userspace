...
// Configure RGB Settings
    ...
    #define RGB_MATRIX_DEFAULT_MODE RGB_MATRIX_SOLID_REACTIVE   // Sets the default effect mode, if none has been set
...
// Show matrix scan rate is debug console in enabled
